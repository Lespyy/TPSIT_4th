...
NON processano insieme MA uno alla volta

Creazione della classe 

Creazione dell'oggetto

e useremo anche l'ereditarietà

Al posto di libreria noi troviamo i moduli

creo le classi

le istanzio

start serve per l'avvio

e join crea la porzione in cui si aspetta l'altro thread

"""

#Codice della prof Minasi
